<div class="barre-interface-bas">
    <div class="bloc-logo-bas bloc-logo-bas-gauche">
        <img src="ressources/images/logo.png" alt="Logo Elementia" class="logo-interface-bas">
    </div>
    ...
    <div class="centre-barre-interface">
        ...
        <button type="button" class="bouton-action-jeu" data-fenetre="carte">Carte</button>
        <button type="button" class="bouton-action-jeu" data-fenetre="codex">Codex</button>
