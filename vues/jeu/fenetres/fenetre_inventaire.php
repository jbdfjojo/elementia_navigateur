...
<div id="fenetre-inventaire"
            ...
            <section class="modele-zone-grille-inventaire" aria-label="Grille de l'inventaire">
                <div class="grille-slots-modele">
                    <?php for ($indexSlot = 1; $indexSlot <= 48; $indexSlot++): ?>
                        ...
                        <div class="slot-inventaire-modele<?= $objet ? ' slot-inventaire-occupe' : '' ?>"
                             ...
                             data-quantite-objet="<?= (int) ($objet['quantite'] ?? 1) ?>"
                             ...
                             <?php endif; ?>
                             title="<?= $objet ? htmlspecialchars((string) ($objet['nom_objet'] ?? ''), ENT_QUOTES, 'UTF-8') : 'Emplacement vide' ?>">

                            <?php if ($objet): ?>
                                <?php $cheminIcone = cheminIconeObjet((string) ($objet['icone_objet'] ?? '')); ?>
                                <?php if ($cheminIcone !== ''): ?>
                                    <img class="slot-inventaire-icone"
                                ...
                                <form method="post" class="formulaire-action-objet formulaire-action-equiper">
                                    <input type="hidden" name="action" value="equiper_objet_inventaire">
                                ...
                                <form method="post" class="formulaire-action-objet formulaire-action-jeter"
                                      onsubmit="return confirm('Jeter cet objet ?');">
    ...
    <div id="menu-contextuel-objet" class="menu-contextuel-objet" hidden>
        <button type="button" data-action-menu="equiper">Équiper</button>
        <button type="button" data-action-menu="jeter">Jeter</button>
    </div>
